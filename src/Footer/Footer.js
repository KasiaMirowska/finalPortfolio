    ...
    return (
      <footer className="footer" id='contact'>
        ...
        <div className='footer-icons'>
          <a href='mailto:amirokasia@gmail.com' className='mail-link link' activeClass ="link-active" target="_blank" rel='noopener noreferrer'><i className="fas fa-envelope fa-4x icon"></i></a>
